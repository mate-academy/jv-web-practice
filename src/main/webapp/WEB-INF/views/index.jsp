...
<table>
    <tr>
        ...
        <td><a href="${pageContext.request.contextPath}/drivers/all">Display all drivers</a></td>
        ...
        <td><a href="${pageContext.request.contextPath}/cars/adddriver">Add driver to car</a></td>
    </tr>
</table>
</body>
</html>