...
<h1>What do you want to do?</h1>
    ...
    <p><a href="${pageContext.request.contextPath}/drivers/all">Display all drivers</a></p>
    <p><a href="${pageContext.request.contextPath}/manufacturers/all">Display all manufacturers</a></p>
    <p><a href="${pageContext.request.contextPath}/cars/all">Display all cars</a></p>
