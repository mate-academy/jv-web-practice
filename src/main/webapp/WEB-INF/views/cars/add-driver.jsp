      ...
      <td>
        <form method="post" style="font-size: 25px" action="${pageContext.request.contextPath}/cars/add-driver">
          ...
          <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Select driver</span>
          ...
          <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default1">Select car</span>
