...
<div class="container">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="${pageContext.request.contextPath}/cars/drivers/add?car_id=${car.id}" type="button"
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${car.drivers}" var="driver">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/cars/drivers/delete?car_id=${car.id}&driver_id=${driver.id}">
