...
<form style="text-align:center" method="post" action="${pageContext.request.contextPath}/registration/cars">
	<a href="${pageContext.request.contextPath}/registration/cars/add">
	...
	<a href="${pageContext.request.contextPath}/registration/cars/plus">
		<button style="width:50%;background-color:#125004;text-align:center" type="button">
			<h2 style="color:#3057b6; background-color: yellow">ADDING DRIVER TO CAR</h2></button>
	</a><br>
	<a href="${pageContext.request.contextPath}/registration/cars/all">
		<button style="width:50%;background-color:#125004;text-align:center" type="button">
