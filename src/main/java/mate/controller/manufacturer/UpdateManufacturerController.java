...
public class UpdateManufacturerController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/WEB-INF/views/manufacturer/update.jsp")
                .forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        String manufacturerName = req.getParameter("Manufacturer name");
        String manufacturerCountry = req.getParameter("Manufacturer country");
    ...
    private Manufacturer getManufacturer(
            Long manufacturerId, String manufacturerName, String manufacturerCountry) {
