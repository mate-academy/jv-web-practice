...
public class UpdateCarController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/WEB-INF/views/car/update.jsp")
                .forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        Car car = getCar(carId, carModel, manufacturerId);
        carService.update(car);
        req.getRequestDispatcher("/WEB-INF/views/Complete.jsp")
                .forward(req,resp);
    }

    private Car getCar(Long carId, String carModel, Long manufacturerId) {
        Car car = new Car();
